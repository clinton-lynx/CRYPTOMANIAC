...
const Dashboard = () => {
  ...
  return (
    <>
      <Header handler={handleChange} slideHandler={mobileNavSlide} />
      <div className="container-wrapper">
        ...
        <main className={` ${theme} main`}>
          <div className="mobile-ref-wrapper"></div>
          {loading ? (
            <Preloader />
          ) : (
                      ...
                      <tr className="assets__table-row">
                        <th className="assets__tableHeading assets--firstHeading">
                          <div className="heading__contentWrapper">
                            <label className="heading__content">#</label>
                          </div>
                        </th>
                        <th className="assets__tableHeading">
                          <div className="heading__contentWrapper">
                            <label className="heading__content">Name</label>
                          </div>
                        </th>
                        <th className="assets__tableHeading">
                          <div className="heading__contentWrapper">
                            <label className="heading__content">Price</label>
                          </div>
                        </th>
                        <th className="assets__tableHeading">
                          <div className="heading__contentWrapper">
                            <label className="heading__content">Change</label>
                          </div>
                        </th>
                      </tr>
                    </thead>
