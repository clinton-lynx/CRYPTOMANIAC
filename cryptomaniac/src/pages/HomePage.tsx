        ...
        <div className="guide__nav-wrapper">
          <ul className="guide__nav-list">
            <li className="guide__nav-list-item">
              <Link className="guide__nav-list-item-link active" to="/lklek">
                Defi
              </Link>
            </li>
            <li className="guide__nav-list-item">
      ...
      <div className="guide__nav-line"></div>
        ...
        <form action="" className="converter-form">
          <div className="first-currency">
            ...
            <input className='input' type="text" name='input1' required /></div>  
        ...
        <img src="https://crypto.com/price/icons/swap-vertical.svg" alt="arrow sign" />
          ...
          <label htmlFor="input2">currency</label>
            <input className='input' type="text" name='input2' required /></div>
        </form>
